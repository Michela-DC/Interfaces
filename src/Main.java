...
public class Main {
    public static void main(String[] args) {
        Student studente = new Student("Marco", "Bianchi", 98345, 2023);
        Professor professore = new Professor("Giulia", "Rossi", 34782, "linguistica inglese");
        Assistant assistente = new Assistant("Luca", "Verdi", 56498, true);
